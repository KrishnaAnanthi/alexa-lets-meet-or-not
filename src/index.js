...
// Questions
var nodes = [{ "node": 1, "message": "Is it an important topic", "yes": 2, "no": 3 },
             { "node": 2, "message": "Can it be solved by collaborating without meeting", "yes": 4, "no": 5 },
             { "node": 5, "message": "Does it require everyone to participate", "yes": 7, "no": 6 },
             { "node": 7, "message": "Does the group have authority to act", "yes": 8, "no": 9 },
             { "node": 8, "message": "Can the key participants and decision makers attend", "yes": 10, "no": 9 },
             { "node": 9, "message": "Is there still value. Can the group still add  significant value by meeting", "yes": 10, "no": 3 },
             { "node": 10, "message": "Is there pre work requested of key participants ", "yes": 11, "no": 12 },
             { "node": 11, "message": "Is there an agenda with clear goals", "yes": 14, "no": 13 },
             { "node": 14, "message": "Is there enough time to get desired outcome ", "yes": 15, "no": 16 },
             { "node": 15, "message": "Is there a strong meeting facilitator", "yes": 17, "no": 18 }, 

// Answers & descriptions
            { "node": 3, "message": "don't need a meeting", "yes": 0, "no": 0, "description": "If this item isn't business critical consider dealing with this topic another way."},
            { "node": 4, "message": "can use other collaboration options", "yes": 0, "no": 0, "description": "Collaborate on a task in ur PM tool Or run a survey or do a quick group chat in online like lync." },
            { "node": 6, "message": "need to find out essential participants then decide again", "yes": 0, "no": 0, "description": "Limited attendees is required. So limit the meeting to essential participants only. Decide the participants first and start again."},
			{ "node": 12, "message": "need to add pre-work", "yes": 0, "no": 0, "description": "Do prework as much as possible to cut down the meeting time"},
            { "node": 13, "message": "need to add agenda and goals then decide again", "yes": 0, "no": 0, "description": "Define a clear outcome and process to get them then start again."},
            { "node": 16, "message": "need to alter the goal and reschedule", "yes": 0, "no": 0, "description": "Make sure meaningful goals can be achieved within your time frame or reschedule it"},
            { "node": 17, "message": "you can have a meeting", "yes": 0, "no": 0, "description": "It is good to have a meeting."},
            { "node": 18, "message": "you need to find a driver for the meeting", "yes": 0, "no": 0, "description": "You need someone who can drive the meeting towards the goals without running over the participants. Find the driver and have a meeting."},
            ];
...
var welcomeMessage = "Welcome to meeting decision maker, are you ready to decide?";
...
var decisionMessage = "I think you ";

// This is the prompt to ask the user if they would like to hear a short description of thier chosen profession or to play again
var playAgainMessage = "Say 'tell me more' to hear a short description for the decision made, or do you want to play again?";

// this is the help message during the setup at the beginning of the game
var helpMessage = "I will ask you some questions that will help you decide whether you need to create a meeting. Want to start now?";
...
exports.handler = function (event, context, callback) {
	...
	alexa.APP_ID = "amzn1.ask.skill.79f483d8-e088-49ef-91d2-cefa06c9b197"; // needs to add
...
var startGameHandlers = Alexa.CreateStateHandler(states.STARTMODE, {
    'AMAZON.YesIntent': function () {
		...
		var loopFound =false;
	   //= helper.debugFunction_walkNode(START_NODE);
        if( loopFound === true)
        {
...
//	return false;
    ...
    debugFunction_AddToVisited: function (nodeId) {
		console.log("adding to visit array"+nodeId)
        if (visited[nodeId] === 1) {
